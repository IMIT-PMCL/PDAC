    ...
    if len(expected_test_identifiers) > 0:
        ...
        for c in expected_test_identifiers:
            ...
            for i in expected_image_files:
                ...
                print(F"Checking for expected image files:{expected_image_files}")
        print(f"Remaining files in imagesTs:{nii_files_in_imagesTs}")
        print("---------------------------")
        print(len(nii_files_in_imagesTs))
        print("---------------------------")
        assert len(
