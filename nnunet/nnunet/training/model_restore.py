...
if __name__ == "__main__":
    pkl = "D:/segmentation/nnUNet-Windows-master/DATASET/nnUNet_trained_models/nnUNet/3d_fullres/Task005_PDAC/nnUNetTrainerV2__nnUNetPlansv2.1/fold0/model_best.model.pkl"
    checkpoint = pkl[:-4]
    train = False
